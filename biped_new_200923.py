...
class Biped:
    ...
    def startSim(self,table=True):
       ...
       # for normal view
        ...
        p.resetDebugVisualizerCamera(cameraDistance = 0.7, cameraYaw= 35, cameraPitch = -9.81, cameraTargetPosition = [1,1,0.4])
       # for experimentation  
    ...
    def getCOMPos(self):
       ...
       # linkmass_data  = p.getDynamicsInfo(self.robot_id,  0)
        ...
        total_height = np.linalg.norm(self.urdf_pos[17]-self.com_base_pos) 

        #self.drawPb2(self.urdf_pos[17])
        
        #self.drawPb1(self.com_base_pos)
