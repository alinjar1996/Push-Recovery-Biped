    ...
    def getCOMPos(self):
       ...
       # self.mass = np.array(i[0] for i in self.linkinfo)
        ...
        for i in range(4,7):
            ...
            I_matrix_Lhip_upper = (((self.inertia_all_matrix[i]) +((total_mass_array[i])*(c_sqaure_Lhip))))
       ...
       # time.sleep(1)
        ...
        for i in range(17,24):
            ...
            I_matrix_Lfoot_upper = (((self.inertia_all_matrix[i]) +((total_mass_array[i])*(c_sqaure_Lfoot))))
      ...
      #  time.sleep(1)
        ...
        for i in range(24,26):
            ...
            c_sqaure_Lfoot= self.equicmatrix(c_vec_Lfoot)
            I_matrix_Lfoot_lower = (((self.inertia_all_matrix[i]) +((total_mass_array[i])*(c_sqaure_Lfoot))))
        ...
        for i in range(27,30):
            ...
            I_matrix_Rhip_upper = (((self.inertia_all_matrix[i]) +((total_mass_array[i])*(c_sqaure_Rhip))))
       ...
       # time.sleep(1)
        ...
        for i in range(30,35):
            ...
            c_sqaure_Rhip= self.equicmatrix(c_vec_Rhip)
            I_matrix_Rhip_lower = (((self.inertia_all_matrix[i]) +((total_mass_array[i])*(c_sqaure_Rhip))))
     ...
     #   time.sleep(1)
        ...
        for i in range(40,47):
            ...
            I_matrix_Rfoot_upper = (((self.inertia_all_matrix[i]) +((total_mass_array[i])*(c_sqaure_Rfoot))))
        ...
        for i in range(47,49):
            ...
            c_sqaure_Rfoot= self.equicmatrix(c_vec_Rfoot)
            I_matrix_Rfoot_lower = (((self.inertia_all_matrix[i]) +((total_mass_array[i])*(c_sqaure_Rfoot))))
